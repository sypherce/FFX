...
export  function Character(_name, _x, _y) {
	...
	var character_object = {
		name: _name,
		face: draw.LoadImage("assets/ffx/" + _name.toLowerCase() + "_face.png"),
		x: _x,
		y: _y,
		hp: -1,
		hp_file: AccessFile('game=ffx&character=' + _name.toLowerCase() + '&stat=curr_hp'),
		max_hp: -1,
		max_hp_file: AccessFile('game=ffx&character=' + _name.toLowerCase() + '&stat=max_hp'),
		mp: -1,
		mp_file: AccessFile('game=ffx&character=' + _name.toLowerCase() + '&stat=curr_mp'),
		max_mp: -1,
		max_mp_file: AccessFile('game=ffx&character=' + _name.toLowerCase() + '&stat=max_mp'),
		slvl: -1,
		slvl_file: AccessFile('game=ffx&character=' + _name.toLowerCase() + '&stat=slvl'),
		draw : function(x, y) {
